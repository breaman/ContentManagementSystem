...
namespace ContentManagementSystem.Data.Migrations
{
    ...
    [Migration("20260819195630_AddNavigationIndex")]
    partial class AddNavigationIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.NavigationItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("NavigationMenuId", "ParentId", "SortOrder")
                        .HasDatabaseName("IX_NavigationItems_Menu_Parent_SortOrder");

                    b.ToTable("NavigationItems", t =>
                        {
                            t.HasCheckConstraint("CK_NavigationItems_OneTarget", "(CASE WHEN [PageId] IS NULL THEN 0 ELSE 1 END +\n CASE WHEN [ExternalUrl] IS NULL THEN 0 ELSE 1 END) = 1");
                        });
                });

            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.NavigationMenu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.OutboxMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.Page", b =>
                {
                    ...
                    b.HasIndex("Depth", "SortOrder")
                        .HasDatabaseName("IX_Pages_Navigation")
                        .HasFilter("[IsDeleted] = 0 AND [ShowInNavigation] = 1");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("Depth", "SortOrder"), new[] { "ParentId", "PublishedVersionId" });
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.PageTag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.SearchDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.NavigationItem", b =>
                {
                    b.HasOne("ContentManagementSystem.Data.Models.Cms.NavigationMenu", "Menu")
                        .WithMany("Items")
                    ...
                    b.HasOne("ContentManagementSystem.Data.Models.Cms.NavigationItem", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("ContentManagementSystem.Data.Models.Cms.PageTag", b =>
                {
                    ...
                    b.HasOne("ContentManagementSystem.Data.Models.Cms.Tag", "Tag")
                        .WithMany("Pages")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
